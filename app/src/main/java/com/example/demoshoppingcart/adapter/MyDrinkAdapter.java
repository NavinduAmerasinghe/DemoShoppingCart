package com.example.demoshoppingcart.adapter;
...
import com.example.demoshoppingcart.R;
import com.example.demoshoppingcart.eventbus.MyUpdateCartEvent;
import com.example.demoshoppingcart.listener.ICartLoadListener;
import com.example.demoshoppingcart.listener.IRecyclerViewClickListener;
import com.example.demoshoppingcart.model.CartModel;
import com.example.demoshoppingcart.model.DrinkModel;
...
public class MyDrinkAdapter extends RecyclerView.Adapter<MyDrinkAdapter.MyDrinkViewHolder> {
    ...
    private void addToCart(DrinkModel drinkModel) {
        DatabaseReference userCart = FirebaseDatabase
                .getInstance()
                .getReference("Cart")
                .child("UNIQUE_USER_ID");//In other projects ,use add user id here
